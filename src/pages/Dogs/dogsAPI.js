  ...
  useEffect(() => {
    ...
    if(selectedBreed){
      fetchSubBreeds(selectedBreed).then((_subBreeds) => {
        console.log("_subBreeds", _subBreeds);
        ...
        if(subBreedsArray.length == 0){
          ...
          console.log("Subbreeds", subBreedsArray);
        }
...
useEffect(()=>{
  ...
  console.log("selectedSubBreed", selectedSubBreed);
...
const viewImages = () =>{
  console.log({selectedBreed, selectedSubBreed, noImages});
      ...
      >
        <div
          ...
          <Form.Item label="Breed">
            ...
            onChange={(v) => setSelectedSubBreed(v)}
            options={SubBreeds}
            />
            </Form.Item>
            }
